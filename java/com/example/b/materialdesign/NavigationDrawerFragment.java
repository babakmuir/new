...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static final String PREF_FILE_NAME="prefTest";
    ...
    public static void savedToPreferences(Context context, String preferencesName, String preferencesValue){
